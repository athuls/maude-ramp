...
bin/ycsb run kaiju -p hosts=155.98.38.114:9910 -p port=9910 -P workloads/workloada -p operationcount=25 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p threadcount=1 -p time=10000 -p valuesize=1
