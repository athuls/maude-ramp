...
public class CoreWorkload extends Workload
{
  ...
  public static final String TRANSACTION_LENGTH_DEFAULT = "8";
	 ...
	 */
	public int doInsert(DB db, Object threadstate)
	{
	...
	public void doTransactionRead(DB db)
	{
        ...
        if(ret == 0)
          Measurements.getMeasurements().measure("READ-TXN", (int)((accum)/1000));
	}
	...
	public void doTransactionReadModifyWrite(DB db)
	{
        ...
        if(ret == 0)
		    Measurements.getMeasurements().measure("READ-MODIFY-WRITE", (int)((accum)/1000));
	}
	...
	public void doTransactionUpdate(DB db)
	{
        ...
        if(ret == 0)
            Measurements.getMeasurements().measure("UPDATE-TXN", (int)((accum)/1000));
	}
	...
	public void doTransactionInsert(DB db)
	{
        ...
        if(ret == 0)
            Measurements.getMeasurements().measure("INSERT-TXN", (int)((accum)/1000));
	}
}
