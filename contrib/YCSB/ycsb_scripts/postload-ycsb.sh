...
then
	...
	bin/ycsb load kaiju -p hosts=155.98.38.$1:$2 -p port=$2 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
elif [ "$#" = "4" ]
then
	bin/ycsb load kaiju -p hosts=155.98.38.$1:$2 -p port=$2 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$3:$4 -p port=$4 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
elif [ "$#" = "6" ]
then
	bin/ycsb load kaiju -p hosts=155.98.38.$1:$2 -p port=$2 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$3:$4 -p port=$4 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$5:$6 -p port=$6 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
elif [ "$#" = "8" ]
then
	bin/ycsb load kaiju -p hosts=155.98.38.$1:$2 -p port=$2 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$3:$4 -p port=$4 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$5:$6 -p port=$6 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$7:$8 -p port=$8 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
elif [ "$#" = "10" ]
then
	bin/ycsb load kaiju -p hosts=155.98.38.$1:$2 -p port=$2 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$3:$4 -p port=$4 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$5:$6 -p port=$6 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$7:$8 -p port=$8 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
	bin/ycsb load kaiju -p hosts=155.98.38.$9:$10 -p port=$10 -P workloads/workloada -p operationcount=1 -p maxexecutiontime=30000 -p isolation_level=READ_ATOMIC -p read_atomic_algorithm=KEY_LIST -p time=10000 -p valuesize=1 -postload -s &
else
