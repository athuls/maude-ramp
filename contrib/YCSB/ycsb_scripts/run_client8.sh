...
#rm /run/shm/*
sed -i -- 's/self = "155.98.38.[0-9]*/self = "155.98.38.'$1'/g' client8.maude
sed -i -- 's/addr1 = "155.98.38.[0-9]*/addr1 = "155.98.38.'$2'/g' client8.maude
../maude-binaries/maude.linux64 -interactive client8.maude > /run/shm/maude_client8_logs.txt
