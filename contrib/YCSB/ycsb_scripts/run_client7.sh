...
sed -i -- 's/self = "155.98.38.[0-9]*/self = "155.98.38.'$1'/g' init-client7.maude
if [ $# == 2 ]
then
	../maude-binaries/alpha117/maude-Yices2.linux64 init-client7_$2.maude > /proj/Confluence/maude/debug_logs/temp/maude_client7_logs_$2.txt
else 
	../maude-binaries/alpha117/maude-Yices2.linux64 init-client7.maude > /proj/Confluence/maude/debug_logs/temp/maude_client7_logs.txt
fi
